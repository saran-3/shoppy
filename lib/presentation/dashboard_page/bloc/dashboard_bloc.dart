...
import 'package:shoppy/presentation/dashboard_page/models/dashboard_model.dart';
...
class DashboardBloc extends Bloc<DashboardEvent, DashboardState> {
  ...
  List<EightysixItemModel> fillEightysixItemList() {
    return List.generate(1, (index) => EightysixItemModel());
  }
  ...
  _onInitialize(
    ...
    emit(state.copyWith(
        dashboardModelObj: state.dashboardModelObj?.copyWith(
            eightysixItemList: fillEightysixItemList(),
